...
{
    public class ResourceSoulRareItem : TileItem
    {
        public int Capacity {get; set;}
        public int Count { get; set; }

        public ResourceSoulRareItem(int capacity)
        {
            ItemType = TileItemType.RESOURCE_RARE_SOUL;
            Capacity = capacity;
            Count = capacity;
        }
        ...
        {
            ResourceSoulRareItem clone = new ResourceSoulRareItem(Capacity);
